...
import { corePluginResult } from '@/socket/events/pluginResult.js'
import { coreConsolePush, dashboardConsoleSubscribe, dashboardConsoleUnsubscribe } from '@/socket/events/console.js'
import type { SocketData } from '@/socket/types.js'
import { activityReport } from '@/socket/events/activityReport.js'
...
export function setupSocketController(fastify: FastifyInstance) {
  ...
  io.onConnection((socket) => {
    ...
    activityReport.register(socket, io, ctx)
